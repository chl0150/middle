...
function preload(){
    ...
    bgImgs[3] = loadImage('scene1-4.png'); //새싹
    bgImgs[4] = loadImage('scene2.png'); //집
    //bgImgs[5] = loadImage('scene3-1.png'); //길
    //bgImgs[6] = loadImage('scene3-2.png'); //길 + 비
    bgImgs[7] = loadImage('scene4.png'); //지하철
    bgImgs[8] = loadImage('scene5-1.png'); //엘리베이터open
    //gImgs[9] = loadImage('scene5-2.png'); //엘리베이터closing
    //bgImgs[10] = loadImage('scene5-3.png'); //엘리베이터closed
    //bgImgs[11] = loadImage('scene6.png'); //발사
    //bgImgs[12] = loadImage('scene7.png'); //캠퍼스길
    bgImgs[13] = loadImage('scene8-1.png'); //작은 나무
    bgImgs[14] = loadImage('scene8-2.png'); //중간 나무
    bgImgs[15] = loadImage('scene8-3.png'); //큰 나무
    bgImgs[16] = loadImage('scene_ending.png'); //ending credit
    bgImgs[17] = loadImage('scene_opening.png'); //opening
    //요소 이미지 생성 
